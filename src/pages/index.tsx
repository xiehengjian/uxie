...
import UploadFileLocalModal from "@/components/workspace/upload-file-local-modal";
...
const UserLibraryPage = () => {
  ...
  // useEffect(() => {
  //   setIsTauri(typeof window !== 'undefined' && typeof window.__TAURI__ !== 'undefined');
  // }, []);
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col px-4 py-2 lg:px-16">
      ...
      <div className="flex items-start justify-between md:px-4">
        ...
        <UploadFileLocalModal />
        {/* {isTauri ? <UploadFileLocalModal /> : <UploadFileModal refetchUserDocs={refetchUserDocs} />} */}
      </div>
